...
// // 自分でAIを実装する場合 -------------------------------------------------------------
// [CreateAssetMenu(menuName = "BattleBrain/InoueBattleBrain")]
// public class InoueBattleBrain : BattleBrain {
...
// ニューラルネットワークのAIを使う場合 --------------------------------------------------
[CreateAssetMenu(menuName = "BattleBrain/InoueBattleBrain")]
public class InoueBattleBrain : NNBattleBrain
{
    /// <summary>
    /// 使用するセンサーの設定.
    /// </summary>
    ...
    /// `InoueBattleBrain`ではInspectorのSelected Inputsで選択したセンサーの値を使う.
    /// </summary>
    public override double[] GetAction(List<double> observation)
    {
...
// // Q学習のAIを使う場合 ----------------------------------------------------------------
// [CreateAssetMenu(menuName = "BattleBrain/InoueBattleBrain")]
// public class InoueBattleBrain : QBattleBrain
// {
//     /// <summary>
